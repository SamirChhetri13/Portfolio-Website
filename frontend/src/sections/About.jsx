        ...
        >
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative group max-w-sm w-full">
              ...
              <div className="relative w-full aspect-square rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-800">
                <img src={profileImg} alt={developerInfo.name} className="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105" />
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              I am dedicated to writing clean, optimized, and maintainable code. My specialization in the MERN stack allows me to construct responsive client apps while designing highly efficient databases and robust API routes on the backend.
            </p>
            
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              Whether building full-stack platforms or focusing strictly on server architecture, database management, and authentication pipelines, I prioritize performance, accessibility, and quality standard methodologies.
            </p>
